...
function createtime() {
  ...
  var start = new Date("08/08/2024 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("08/08/2024 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign'  title='早上好shix，现在是白天，别懈怠~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' title='晚上了，记得跑步和作息规律~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn-fusion.imgimg.cc/i/2024/afaf05e50f17a5c8.jpg);
    --darkmode-bg:url(https://cdn-fusion.imgimg.cc/i/2024/afaf05e50f17a5c8.jpg);
    --mobileday-bg: url(https://cdn-fusion.imgimg.cc/i/2024/afaf05e50f17a5c8.jpg);
    --mobilenight-bg: url(https://cdn-fusion.imgimg.cc/i/2024/afaf05e50f17a5c8.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
